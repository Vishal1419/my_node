        ...
        schema:{
            ...
            city_area:{
                ...
                errors:{
                    type:{
                        errorCode:VccResponse.INVALID_DATA_TYPE,
                        message:constants.ERROR_MESSAGES.CITY_AREA_STRING_INVALID_DT
                    }
                }
            },
            city:{
        ...
        schema:{
            ...
            name:{
                ...
                errors:{
                    type:{
                        errorCode:VccResponse.INVALID_DATA_TYPE,
                        message:constants.ERROR_MESSAGES.RESTAURANT_NAME_DT
                    }
                }
            },
            wine_color:{
            ...
            wine_name:{
                ...
                errors:{
                    type:{
                        errorCode:VccResponse.INVALID_DATA_TYPE,
                        message:constants.ERROR_MESSAGES.WINE_NAME_DT
                    }
                }
            },
            wine_min_price:{
        ...
        schema: {
            ...
            food_category:{
                ...
                errors:{
                    type:{
                        errorCode:VccResponse.INVALID_DATA_TYPE,
                        message:constants.ERROR_MESSAGES.FOOD_CATEGORY_NAME_DT
                    },
                    match:{
                        errorCode:VccResponse.REQUIRED_FIELD,
            ...
            food:{
                ...
                errors:{
                    type:{
                        errorCode:VccResponse.INVALID_DATA_TYPE,
                        message:constants.ERROR_MESSAGES.FOOD_DT
                    },
                    match:{
                        errorCode:VccResponse.REQUIRED_FIELD,
